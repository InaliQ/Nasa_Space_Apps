document.addEventListener("DOMContentLoaded", function() {
    ...
    button.addEventListener('click', function() {
        ...
        img1.src = '../../../source/planetas/TRAPPIST-1e.png'; // Ruta de la primera imagen

        const img2 = new Image();
        img2.src = '../../../source/vistas/e_norte.png'; // Ruta de la segunda imagen

        const img3 = new Image();
        img3.src = '../../../source/vistas/e_sur.png'; // Ruta de la tercera imagen
