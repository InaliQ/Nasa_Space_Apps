document.addEventListener("DOMContentLoaded", function() {
    ...
    button.addEventListener('click', function() {
        ...
        img1.src = '../../../source/planetas/TRAPPIST-1f.png'; // Ruta de la primera imagen

        const img2 = new Image();
        img2.src = '../../../source/vistas/f_norte.png'; // Ruta de la segunda imagen

        const img3 = new Image();
        img3.src = '../../../source/vistas/f_sur.png'; // Ruta de la tercera imagen
